...
def main(config):
    ...
    for filename in filenames:
        ...
        if ext =='.jpg':
            ...
            # data_list.append(filename[0]+'s' + filename[-1])
            # GT_list.append(filename[0] + 's' + filename[-1])

            filename = filename.split('_')[-1][:-len('.jpg')]
            data_list.append('ISIC_'+filename+'.jpg')
            GT_list.append('ISIC_'+filename+'_segmentation.jpg')
...
if __name__ == '__main__':
    ...
    # data path
    parser.add_argument('--origin_data_path', type=str, default='./Train')
    parser.add_argument('--origin_GT_path', type=str, default='./GroundTruth')
