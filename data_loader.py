...
class ImageFolder(data.Dataset):
	...
	def __getitem__(self, index):
		...
		GT_path = self.GT_paths + 'ISIC_' + filename + '_segmentation.jpg'
		...
		# Norm_ = T.Normalize((0.5, 0.5, 0.5), (0.5, 0.5, 0.5)) Original Code (used to process image with 3 channels --Maksim Shi)
		image = Norm_(image)
